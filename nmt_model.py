...
class NMT(nn.Module):
    ...
    """
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2, rnn_layer=nn.LSTM, num_layers=1, activation=torch.tanh):
        """ Init NMT Model.
        ...
        self.encoder = rnn_layer(input_size=embed_size, hidden_size=hidden_size, bidirectional=True, bias=True, num_layers=num_layers)
